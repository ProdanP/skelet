...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            mTabsContainer.setLayoutDirection(LAYOUT_DIRECTION_LOCALE);
        }
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (onTabClickListener != null) {
                    onTabClickListener.onTabClicked(mTabsContainer.getChildAt(mPager.getCurrentItem()), position);
                }
        ...
        mTabLayoutParams.width = metrics.widthPixels / getTabCount();
    ...
    public interface OnTabClickListener {
        void onTabClicked(View tab, int position);
    }
